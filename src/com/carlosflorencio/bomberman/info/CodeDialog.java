package com.carlosflorencio.bomberman.info;
...
public class CodeDialog implements WindowListener, ActionListener {
	...
	public CodeDialog(Frame f) {
		...
		_dialog = new JFrame("Enter level");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(_frame.validCode(code)) {
			_frame.changeLevel(Integer.parseInt(code));
			_valid = true;
			_dialog.dispose();
		} else {
