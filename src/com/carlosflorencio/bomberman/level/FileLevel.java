...
import com.carlosflorencio.bomberman.entities.mob.enemy.*;
	...
	public void addLevelEntity(char c, int x, int y) {
		...
		switch(c) { // TODO: minimize this method
			...
			case '5':
				...
				break;
			case '6':
				_board.addMob( new Stupid(Coordinates.tileToPixel(x), Coordinates.tileToPixel(y) + Game.TILES_SIZE, _board));
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
				break;
			case '7':
				_board.addMob( new Intelligent(Coordinates.tileToPixel(x), Coordinates.tileToPixel(y) + Game.TILES_SIZE, _board));
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
				break;
			case '8':
				_board.addMob( new Boss(Coordinates.tileToPixel(x), Coordinates.tileToPixel(y) + Game.TILES_SIZE, _board));
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
				break;
			default: 
				_board.addEntitie(pos, new GrassTile(x, y, Sprite.grass) );
